#!/bin/bash
#PBS -N SRX055381.Ray-Communities-2012-10-05.3
#PBS -o SRX055381.Ray-Communities-2012-10-05.3.stdout
#PBS -e SRX055381.Ray-Communities-2012-10-05.3.stderr
#PBS -A nne-790-ab
...
mpiexec -n 48 \
-bynode \
-output-filename SRX055381.Ray-Communities-2012-10-05.3 \
Ray \
 -o \
 SRX055381.Ray-Communities-2012-10-05.3 \
 -k \
 31 \
