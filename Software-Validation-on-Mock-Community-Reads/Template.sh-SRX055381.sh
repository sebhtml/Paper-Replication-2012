#!/bin/bash
#PBS -N SRX055381.Ray-Communities-2012-10-14.1
#PBS -o SRX055381.Ray-Communities-2012-10-14.1.stdout
#PBS -e SRX055381.Ray-Communities-2012-10-14.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 32 \
-output-filename SRX055381.Ray-Communities-2012-10-14.1 \
Ray \
 -o \
 SRX055381.Ray-Communities-2012-10-14.1 \
 -k \
 31 \
...
mv SRX055381.Ray-Communities-2012-10-14.1.* SRX055381.Ray-Communities-2012-10-14.1
