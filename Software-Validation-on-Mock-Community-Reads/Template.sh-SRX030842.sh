#!/bin/bash
#PBS -N SRX030842.Ray-Communities-2012-10-05.3
#PBS -o SRX030842.Ray-Communities-2012-10-05.3.stdout
#PBS -e SRX030842.Ray-Communities-2012-10-05.3.stderr
#PBS -A nne-790-ab
...
mpiexec -n 48 \
-bynode \
-output-filename SRX030842.Ray-Communities-2012-10-05.3 \
Ray \
 -o \
 SRX030842.Ray-Communities-2012-10-05.3 \
 -k \
 31 \
