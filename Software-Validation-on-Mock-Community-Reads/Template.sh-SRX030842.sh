#!/bin/bash
#PBS -N SRX030842.Ray-Communities-2012-10-21.1-64
#PBS -o SRX030842.Ray-Communities-2012-10-21.1-64.stdout
#PBS -e SRX030842.Ray-Communities-2012-10-21.1-64.stderr
#PBS -A nne-790-ab
...
mpiexec -n 64 \
-output-filename SRX030842.Ray-Communities-2012-10-21.1-64 \
Ray \
 -o \
 SRX030842.Ray-Communities-2012-10-21.1-64 \
 -k \
 21 \
 -s SRX030842.fastq.gz \
  -search \
...
mv SRX030842.Ray-Communities-2012-10-21.1-64.* SRX030842.Ray-Communities-2012-10-21.1-64
