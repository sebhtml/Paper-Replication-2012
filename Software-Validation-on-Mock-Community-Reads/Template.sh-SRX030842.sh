#!/bin/bash
#PBS -N SRX030842.Ray-Communities-2012-10-14.1
#PBS -o SRX030842.Ray-Communities-2012-10-14.1.stdout
#PBS -e SRX030842.Ray-Communities-2012-10-14.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 32 \
-output-filename SRX030842.Ray-Communities-2012-10-14.1 \
Ray \
 -o \
 SRX030842.Ray-Communities-2012-10-14.1 \
 -k \
 31 \
...
mv SRX030842.Ray-Communities-2012-10-14.1.* SRX030842.Ray-Communities-2012-10-14.1
