#!/bin/bash
#PBS -N SRX030842.Ray-Communities-2012-10-16.1-32
#PBS -o SRX030842.Ray-Communities-2012-10-16.1-32.stdout
#PBS -e SRX030842.Ray-Communities-2012-10-16.1-32.stderr
#PBS -A nne-790-ab
...
mpiexec -n 32 \
-output-filename SRX030842.Ray-Communities-2012-10-16.1-32 \
Ray \
 -o \
 SRX030842.Ray-Communities-2012-10-16.1-32 \
 -k \
 21 \
...
mv SRX030842.Ray-Communities-2012-10-16.1-32.* SRX030842.Ray-Communities-2012-10-16.1-32
