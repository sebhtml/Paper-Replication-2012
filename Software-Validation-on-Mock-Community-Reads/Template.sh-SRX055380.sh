#!/bin/bash
#PBS -N SRX055380.Ray-Communities-2012-10-21.1-64
#PBS -o SRX055380.Ray-Communities-2012-10-21.1-64.stdout
#PBS -e SRX055380.Ray-Communities-2012-10-21.1-64.stderr
#PBS -A nne-790-ab
...
mpiexec -n 64 \
-output-filename SRX055380.Ray-Communities-2012-10-21.1-64 \
Ray \
 -o \
 SRX055380.Ray-Communities-2012-10-21.1-64 \
 -k \
 21 \
...
mv SRX055380.Ray-Communities-2012-10-21.1-64.* SRX055380.Ray-Communities-2012-10-21.1-64
