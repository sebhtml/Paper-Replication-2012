#!/bin/bash
#PBS -N SRX055380.Ray-Communities-2012-10-13.1
#PBS -o SRX055380.Ray-Communities-2012-10-13.1.stdout
#PBS -e SRX055380.Ray-Communities-2012-10-13.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 32 \
-output-filename SRX055380.Ray-Communities-2012-10-13.1 \
Ray \
 -o \
 SRX055380.Ray-Communities-2012-10-13.1 \
 -k \
 31 \
...
mv SRX055380.Ray-Communities-2012-10-13.1.* SRX055380.Ray-Communities-2012-10-13.1
