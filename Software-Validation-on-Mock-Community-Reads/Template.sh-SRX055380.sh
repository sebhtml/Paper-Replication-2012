#!/bin/bash
#PBS -N SRX055380.Ray-Communities-2012-10-11.1
#PBS -o SRX055380.Ray-Communities-2012-10-11.1.stdout
#PBS -e SRX055380.Ray-Communities-2012-10-11.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 48 \
-bynode \
-output-filename SRX055380.Ray-Communities-2012-10-11.1 \
Ray \
 -o \
 SRX055380.Ray-Communities-2012-10-11.1 \
 -k \
 31 \
