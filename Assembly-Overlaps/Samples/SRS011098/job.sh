#!/bin/bash
#PBS -N SRS011098-overlaps-2012-10-19.1
#PBS -o SRS011098-overlaps-2012-10-19.1.stdout
#PBS -e SRS011098-overlaps-2012-10-19.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 96 \
-output-filename SRS011098-overlaps-2012-10-19.1 \
Ray \
-k 31 \
-o SRS011098-overlaps-2012-10-19.1 \
...
mv SRS011098-overlaps-2012-10-19.1.* SRS011098-overlaps-2012-10-19.1
