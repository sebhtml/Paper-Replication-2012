#!/bin/bash
#PBS -N ERS006494-overlaps-2012-10-14.1
#PBS -o ERS006494-overlaps-2012-10-14.1.stdout
#PBS -e ERS006494-overlaps-2012-10-14.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 96 \
-output-filename ERS006494-overlaps-2012-10-14.1 \
Ray \
-k 31 \
-o ERS006494-overlaps-2012-10-14.1 \
...
mv ERS006494-overlaps-2012-10-14.1.* ERS006494-overlaps-2012-10-14.1
