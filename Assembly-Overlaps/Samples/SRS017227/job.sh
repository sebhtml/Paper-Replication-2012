#!/bin/bash
#PBS -N SRS017227-overlaps-2012-10-06.1
#PBS -o SRS017227-overlaps-2012-10-06.1.stdout
#PBS -e SRS017227-overlaps-2012-10-06.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 96 \
-output-filename SRS017227-overlaps-2012-10-06.1 \
Ray \
-k 31 \
-o SRS017227-overlaps-2012-10-06.1 \
-search Assemblies
