#!/bin/bash
#PBS -N SRS018661-overlaps-2012-10-14.1
#PBS -o SRS018661-overlaps-2012-10-14.1.stdout
#PBS -e SRS018661-overlaps-2012-10-14.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 96 \
-output-filename SRS018661-overlaps-2012-10-14.1 \
Ray \
-k 31 \
-o SRS018661-overlaps-2012-10-14.1 \
...
mv SRS018661-overlaps-2012-10-14.1.* SRS018661-overlaps-2012-10-14.1
