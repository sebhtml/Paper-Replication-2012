#!/bin/bash
#PBS -N SRS018661-overlaps-2012-10-03.1
#PBS -o SRS018661-overlaps-2012-10-03.1.stdout
#PBS -e SRS018661-overlaps-2012-10-03.1.stderr
#PBS -A nne-790-ab
...
mpiexec -n 96 \
-output-filename SRS018661-overlaps-2012-10-03.1 \
Ray \
-k 31 \
-o RayOutput \
-search Assemblies
...
mv SRS018661-overlaps-2012-10-03.1.* RayOutput
